...
If you want you can add another element to the paragraph array, from here it randomly draws the paragraphs to display.
...
You can also change the type of label to display
